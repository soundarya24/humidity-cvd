...
daly_2030 <- readRDS(here::here(
  "output", "daly-projections", "absDALY2030_hi.rds"
)) 
...
daly_totalburden_cvd_2030 <- daly_2030_cpd2030 |> 
  dplyr::mutate(
    totaleconBurden_2030=paf_daly_proj2030_avg975hi*CpD_2030
  )



# save as rds and csv
saveRDS(daly_totalburden_cvd_2030, here::here("output","total-econ-burden-projections","heatindex_daly_totalburden_cvd_2030.rds"))
write_csv(daly_totalburden_cvd_2030, here::here("output","total-econ-burden-projections","heatindex_daly_totalburden_cvd_2030.csv"))  
